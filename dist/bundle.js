...
var _betterScroll = __webpack_require__(5);
...
var _bubble = __webpack_require__(11);
...
var Scroll = function (_Component) {
  ...
  function Scroll(props, context) {
    ...
    _this.getScrollObj = function () {
      return _this.scroll;
    };

    _this._reboundPullDown = function () {
      var _this$options$pullDow = _this.options.pullDownRefresh.stopTime,
          stopTime = _this$options$pullDow === undefined ? 600 : _this$options$pullDow;


      return new Promise(function (resolve) {
        _this.TimerA = setTimeout(function () {
    ...
    _this._initPullUpLoad = function () {
      _this.scroll.on('pullingUp', function () {
        ...
        _this.props.pullUpLoad().catch(function () {
          if (!_this.scroll) {
            return;
          }
          _this.setState({
    ...
    _this.scroll = null; // scroll 实例

    _this.isRebounding = false; //反弹
    _this.pullDownInitTop = -50;
  ...
  _createClass(Scroll, [{
    ...
    value: function initScroll() {
      var _props = this.props,
          probeType = _props.probeType,
          click = _props.click,
          startY = _props.startY,
          scrollY = _props.scrollY,
          scrollX = _props.scrollX,
          freeScroll = _props.freeScroll,
          scrollbar = _props.scrollbar,
          pullDownRefresh = _props.pullDownRefresh,
          pullUpLoad = _props.pullUpLoad,
          preventDefaultException = _props.preventDefaultException,
          eventPassthrough = _props.eventPassthrough,
      ...
      var wrapper = this.refs.$dom;
      this.scroll = new _betterScroll2.default(wrapper, this.options);
      this.initEvents();
    }
  }, {
    key: 'initEvents',
    ...
    key: '_initPullDownRefresh',


    //下拉刷新
    value: function _initPullDownRefresh() {
      var _this3 = this;
      ...
      this.scroll.on('pullingDown', function () {
        ...
        _this3.props.pullDownRefresh().then(function () {
      ...
      this.scroll.on('scroll', function (pos) {
        var beforePullDown = _this3.state.beforePullDown;
        ...
        if (beforePullDown) {
          _this3.setState({
            bubbleY: Math.max(0, pos.y + _this3.pullDownInitTop),
            pullDownStyle: {
              top: Math.min(pos.y + _this3.pullDownInitTop, 10) + 'px'
            }
          });
        } else {
          _this3.setState({
    ...
    value: function _afterPullDown() {
      ...
      this.TimerB = setTimeout(function () {
        _this4.setState({
          ...
          pullDownErr: false,
          pullDownStyle: {
            top: _this4.pullDownInitTop + 'px'
          }
        });
        _this4.isRebounding = false;
    ...
    key: 'renderPullUpLoad',


    //上拉加载render
    value: function renderPullUpLoad() {
      var _props2 = this.props,
          pullUpLoad = _props2.pullUpLoad,
          isPullUpTipHide = _props2.isPullUpTipHide,
          noMore = _props2.noMore;
      var pullUpErr = this.state.pullUpErr;
      ...
      if (pullUpLoad && this.state.isPullUpLoad) {
        return _react2.default.createElement(
          'div',
          { className: 'b-pullup-wrapper' },
          _react2.default.createElement(
            'div',
            { className: 'after-trigger', style: { lineHeight: '.32rem' } },
            _react2.default.createElement('i', { className: 'loading-icon' }),
            _react2.default.createElement(
              'span',
              { style: { color: '#999999', fontSize: '.28rem' } },
              ' \u52A0\u8F7D\u4E2D...'
            )
          )
        );
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'span',
              { style: { color: '#999999', fontSize: '.28rem' } },
              pullUpErr ? '加载失败' : noMore ? '我是有底线的' : '加载完成'
            )
          )
        );
      }
    ...
    key: 'renderPullUpDown',
    value: function renderPullUpDown() {
      var pullDownRefresh = this.props.pullDownRefresh;
      var _state = this.state,
          beforePullDown = _state.beforePullDown,
          pulling = _state.pulling,
          pullDownErr = _state.pullDownErr,
          pullDownStyle = _state.pullDownStyle;


      if (pullDownRefresh && beforePullDown) {
        return _react2.default.createElement(
          'div',
          { className: 'b-pulldown-wrapper', style: pullDownStyle },
          _react2.default.createElement(
            'div',
            { className: 'before-trigger' },
            _react2.default.createElement(_bubble2.default, { y: this.state.bubbleY })
          )
        );
      }
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'b-wrapper', ref: '$dom' },
        _react2.default.createElement(
          'div',
          { className: 'b-scroll-content' },
          this.props.children,
...
Scroll.propTypes = {
  ...
  probeType: _propTypes2.default.number,
  startY: _propTypes2.default.number,
  click: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.bool]),
  ...
  pullDownRefresh: _propTypes2.default.func,
  pullUpLoad: _propTypes2.default.func,
  doScroll: _propTypes2.default.func,
  doScrollStart: _propTypes2.default.func,
  doScrollEnd: _propTypes2.default.func,
  preventDefaultException: _propTypes2.default.object,
  eventPassthrough: _propTypes2.default.string,
  isPullUpTipHide: _propTypes2.default.bool,
...
var loadingImg = __webpack_require__(10);
  ...
  _createClass(Loading, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement('img', { src: loadingImg, alt: 'loading' })
      );
    }
  }]);
...
// module
exports.push([module.i, ".loading_container {\n    width: 100%;\n}\n\n.loading_container img {\n    display: block;\n    width: 20px;\n    height: 20px;\n    margin: 0 auto;\n}\n", ""]);
...
var Bubble = function (_Component) {
  ...
  _createClass(Bubble, [{
    ...
    key: 'render',
    value: function render() {
      return _react2.default.createElement('canvas', { id: 'bubble', width: this.width, height: this.height, style: this.state.style });
    }
  }]);
